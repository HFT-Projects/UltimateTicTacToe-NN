...
static NNActor actorX = new NNActor(PLAYER.X, new FFN(LAYER_SIZES, HIDDEN_ACTIVATIONS, OUTPUT_ACTIVATION, LOSS_FUNCTION), new FFNTrainerSGD(), ALPHA, GAMMA, EPSILON);
static NNActor actorO = new NNActor(PLAYER.O, new FFN(LAYER_SIZES, HIDDEN_ACTIVATIONS, OUTPUT_ACTIVATION, LOSS_FUNCTION), new FFNTrainerSGD(), ALPHA, GAMMA, EPSILON);
